...
export const mainChainAssetData: BFChainCore.GenesisAssetJSON = {
  ...
  rewardPerBlock: {
    heights: [
      1, 100000, 18900000, 37800000, 56700000, 75600000, 94500000, 113400000, 132300000, 151200000,
      170100000, 189000000, 207900000, 226800000, 245700000, 264600000, 283500000, 302400000,
      321300000, 340200000, 359100000, 378000000, 396900000, 403200000,
    ],
    rewards: [
      "0",
      "3500000000",
