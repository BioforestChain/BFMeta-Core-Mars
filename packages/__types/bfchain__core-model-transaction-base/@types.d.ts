declare namespace BFChainCore {
    ...
    type GetAssetModel<T> = GetMessageAssetModel<T> extends import("@bfchain/protobuf").Message<infer U> ? U : any;
    ...
    type AcceptVoteTransactionJSON = TransactionMixJSON<AcceptVoteAssetJSON, {
        hasRecipientId: false;
    }>;
    type BeExchangeAssetTransactionJSON = TransactionMixJSON<BeExchangeAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type BeExchangeSpecialAssetTransactionJSON = TransactionMixJSON<BeExchangeSpecialAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type CustomTransactionJSON = TransactionJSON<CustomAssetJSON>;
    type DAppPurchasingTransactionJSON = TransactionMixJSON<DAppPurchasingAssetJSON, {
        hasRecipientId: true;
    }>;
    type DAppTransactionJSON = TransactionMixJSON<DAppAssetJSON, {
        hasRecipientId: false;
    }>;
    type DelegateTransactionJSON = TransactionMixJSON<DelegateAssetJSON, {
        hasRecipientId: false;
    }>;
    type DestoryAssetTransactionJSON = TransactionMixJSON<DestoryAssetAssetJSON, {
        hasRecipientId: false;
    }>;
    type EmigrateAssetTransactionJSON = TransactionMixJSON<EmigrateAssetAssetJSON, {
        hasRecipientId: false;
    }>;
    type GiftAssetTransactionJSON = TransactionMixJSON<GiftAssetAssetJSON, {
        hasRecipientId: false;
    }>;
    type GrabAssetTransactionJSON = TransactionMixJSON<GrabAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type ImmigrateAssetTransactionJSON = TransactionMixJSON<ImmigrateAssetAssetJSON, {
        hasRecipientId: false;
    }>;
    type IssueAssetTransactionJSON = TransactionMixJSON<IssueAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type LocationNameTransactionJSON = TransactionMixJSON<LocationNameAssetJSON, {
        hasRecipientId: false;
    }>;
    type MarkTransactionJSON = TransactionMixJSON<MarkAssetJSON, {
        hasRecipientId: true;
    }>;
    type RejectVoteTransactionJSON = TransactionMixJSON<RejectVoteAssetJSON, {
        hasRecipientId: false;
    }>;
    type SetLnsManagerTransactionJSON = TransactionMixJSON<SetLnsManagerAssetJSON, {
        hasRecipientId: true;
    }>;
    type SetLnsRecordValueTransactionJSON = TransactionMixJSON<SetLnsRecordValueAssetJSON, {
        hasRecipientId: false;
    }>;
    type SignatureTransactionJSON = TransactionMixJSON<SignatureAssetJSON, {
        hasRecipientId: false;
    }>;
    type SignForAssetTransactionJSON = TransactionMixJSON<SignForAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type ToExchangeAssetTransactionJSON = TransactionMixJSON<ToExchangeAssetAssetJSON, {
        hasRecipientId: false;
    }>;
    type ToExchangeSpecialAssetTransactionJSON = TransactionMixJSON<ToExchangeSpecialAssetAssetJSON, {
        hasRecipientId: false;
    }>;
    type TransferAssetTransactionJSON = TransactionMixJSON<TransferAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type TrustAssetTransactionJSON = TransactionMixJSON<TrustAssetAssetJSON, {
        hasRecipientId: true;
    }>;
    type UsernameTransactionJSON = TransactionMixJSON<UsernameAssetJSON, {
        hasRecipientId: false;
    }>;
    type VoteTransactionJSON = TransactionMixJSON<VoteAssetJSON, {
        hasRecipientId: true;
    }>;
