export const ERROR_CODE_LIST_EN = {
  ...
  "001-00035": "Genesis generator not enough, at least {expected}, actual {actual}",
  ...
  "001-11034": "Account with address {address} is already an generator, errorId {errorId}",
  "001-11035": "Account with address {address} is not an generator, errorId {errorId}",
  ...
  "001-11051": "Can not destroy entityId {entityId}, reason {reason}",
  "001-11052": "Entity already destroy, entityId {entityId}",
  ...
  "001-11057": "The register generator quota is full in round {round}",
  "001-11058": "Generator can not migrate asset",
