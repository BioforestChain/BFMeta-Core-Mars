...
export enum DUPLEX_API_CMD {
  ...
  QUERY_TINDEX_RETURN = DUPLEX_API_CMD.RESPONSE | DUPLEX_API_CMD.QUERY_TINDEX,
  GET_TRANSACTIONINBLOCK_RETURN = DUPLEX_API_CMD.RESPONSE | DUPLEX_API_CMD.GET_TRANSACTIONINBLOCK,
}
