declare namespace BFChainCore {
    ...
    interface ChannelEndpointInterface<T = Uint8Array> {
        ...
        onClose(handle: (error: import("@bfchain/util").InterruptedException) => any): EventListenerRemover;
    ...
    type CurrentGenerateBlockInfo = Omit<BFChainCore.NewBlockArgJSON, "blockId"> | Omit<BlockPlotChecker, "blockId">;
    interface BlockGetterHelperInterface<CC extends import("./atom_channel").ChainChannel = import("./atom_channel").ChainChannel> {
        /**根据高度获取区块 */
        ...
        /**获取新一轮的打块受托人 */
        getNewForgingDelegates?(lastBlock: LastBlockInfo, currentGeneraterPublicKey: string): Promise<BFChainCore.AccountBaseInfo[]>;
        /**查询交易是否存在 */
        getCountBlock?(args: {
            /**区块高度 */
            height?: number;
    ...
    interface BlockTickGetterHelperInterface<CC extends import("./atom_channel").ChainChannel = import("./atom_channel").ChainChannel> {
        /**保存参与投票账户的权益 */
    ...
    interface AccountGetterHelperInterface<T extends AccountBaseInfo> {
        ...
        getVoteForDelegate(address: string, delegate: string, dappid: string, 
        /**当前轮次 */
    ...
    interface TransactionGetterHelperInterface<CC extends import("./atom_channel").ChainChannel = import("./atom_channel").ChainChannel> {
        /**根据交易 id 获取交易 */
