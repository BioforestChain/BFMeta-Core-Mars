import {
  ...
  StatisticInfoModel,
} from "../model/blockRemarkModel/statisticInfo";
import { StringKeyMap } from "../model/common/mapField";
import { TransactionHelper } from "./transactionHelper";
import { ChainAssetInfoHelper, ChainAssetInfo } from "./chainAssetInfoHelper";
...
export class StatisticsInfo extends EventEmitter<{ destroy: [] }> {
  ...
  constructor(
    ...
    private readonly source_data = StatisticInfoModel.fromObject({}),
...
class CountAndAmountStatistic {
  constructor(private readonly source_data = CountAndAmountStatisticModel.fromObject({})) {}
