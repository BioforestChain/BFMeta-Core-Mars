...
/**通用的进度事件进度模型 */
export declare class ProgressEventModel<EVENT extends string> extends Message<ProgressEventModel<EVENT>> implements BFChainCore.JSONToModelType<BFChainCore.ProgressEventJSON> {
    static INC: number;
    type: EVENT;
...
//# sourceMappingURL=progressEvent.model.d.ts.map