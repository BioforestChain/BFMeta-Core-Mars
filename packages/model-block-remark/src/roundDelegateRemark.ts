...
export class NextRoundDelegateModel extends Message<NextRoundDelegateModel>
...
export class RoundDelegateRemarkModel<T extends RoundDelegateRemarkModel<T>> extends Message<T>
