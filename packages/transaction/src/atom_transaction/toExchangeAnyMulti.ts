...
export class ToExchangeAnyMultiTransactionFactory extends TransactionFactory<ToExchangeAnyMultiTransaction> {
  ...
  async verifyTransactionBody(
    ...
    const cipherPublicKeys = toExchangeAnyMulti.cipherPublicKeys;
    ...
    const { toExchangeAssets, beExchangeAsset, numberOfEffectiveBlocks } = toExchangeAnyMulti;
  ...
  applyTransaction(
    ...
    return wrapTaskList((taskList) => {
      ...
      const { toExchangeAssets, beExchangeAsset, numberOfEffectiveBlocks } =
        transaction.asset.toExchangeAnyMulti;
