declare namespace BFChainCore {
    type TransactionFactory<T extends Transaction> = import("./atom_transaction/_txbase").TransactionFactory<T>;
    type TransactionFactoryConstructor<T extends Transaction = any> = new (...args: any[]) => TransactionFactory<T>;
    ...
    type ApplyResultJSON = ApplyResult_SetSecondPublicKeyJSON | ApplyResult_SetUsernameJSON | ApplyResult_RegisterToDelegateJSON | ApplyResult_AcceptVoteJSON | ApplyResult_RejectVoteJSON | ApplyResult_VoteEquityJSON | ApplyResult_AssetJSON | ApplyResult_DestoryAssetJSON | ApplyResult_FrozenAssetJSON | ApplyResult_UnfrozenAssetJSON | ApplyResult_FrozenAccountJSON | ApplyResult_IssueDAppidJSON | ApplyResult_SaleDAppidJSON | ApplyResult_PurchaseDAppidJSON | ApplyResult_IssueAssetJSON | ApplyResult_IssueSubchainJSON | ApplyResult_RegisterLocationNameJSON | ApplyResult_CancelLocationNameJSON | ApplyResult_SetLnsManagerJSON | ApplyResult_SetLnsRecordValueJSON | ApplyResult_SaleLocationNameJSON | ApplyResult_PurchaseLocationNameJSON;
    interface CustomTrCenterInterface {
        verify(body: TxBodyJSON, customAsset: CustomAssetJSON, config: import("@bfchain/core-helper-config").ConfigHelper): {
            ret: boolean;
            message?: string;
        };
        apply(tx: BFChainCore.Transaction, config: import("@bfchain/core-helper-config").ConfigHelper): ApplyResultJSON[];
        logicVerify(tx: BFChainCore.Transaction): Promise<{
            ret: boolean;
            message?: string;
        }>;
    }
    interface AccountApiInterface {
        ...
        getAccountEquityInfo(address: string): Promise<{
            round: number;
            equity: string;
        }>;
    ...
    interface TransactionApiInterface {
        ...
        getTransactionBySenderIdAndType(senderId: string, type?: string, limit?: number, offset?: number): Promise<TransactionJSON[]>;
        getTransactionByRecipientIdAndType(recipientId: string, type?: string, limit?: number, offset?: number): Promise<TransactionJSON[]>;
        getTransactionByQueryOptions(queryOptions: TransactionQueryOptionsJSON): Promise<TransactionInBlockJSON[]>;
    }
    interface BlockApiInterface {
        ...
        getBlockByBlocksGenerator(generatorPublicKey: string, limit?: number, offset?: number): Promise<BlockJSON<any>>;
    }
