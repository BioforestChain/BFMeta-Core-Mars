...
const { ArgumentIllegalException } = core_util_exception_1.CoreExceptionGenerator("CONTROLLER", "TrustAssetTransactionFactory");
/**
 * trustAsset 交易工厂
 *
 */
let TrustAssetTransactionFactory = class TrustAssetTransactionFactory extends _txbase_1.TransactionFactory {
     ...
     */
    verifyTransactionBody(body, trustAssetAsset, config = this.configHelper) {
    ...
    verifyTrustAsset(trustAsset) {
        ...
        if (numberOfSignFor > maxSifnFor) {
            throw new ArgumentIllegalException(core_util_exception_1.PROP_SHOULD_LTE_FIELD, {
                prop: "numberOfSignFor",
                target: "trustAsset",
                field: maxSifnFor,
                ...TrustAssetAsset_Exception_Detail,
     ...
     * @param trustAssetAsset
     */
    init(body, trustAssetAsset) {
        const transaction = core_model_1.TrustAssetTransaction.fromObject({
            ...body,
...
TrustAssetTransactionFactory = __decorate([
    util_1.Injectable(),
...
exports.TrustAssetTransactionFactory = TrustAssetTransactionFactory;
