...
const { ArgumentIllegalException } = core_util_exception_1.CoreExceptionGenerator("CONTROLLER", "RejectVoteTransactionFactory");
/**
 * rejectVote 交易工厂
 *
 */
let RejectVoteTransactionFactory = class RejectVoteTransactionFactory extends _txbase_1.TransactionFactory {
     ...
     */
    verifyTransactionBody(body, rejectVoteAsset, config = this.configHelper) {
     ...
     * @param rejectVoteAsset
     */
    init(body, rejectVoteAsset) {
        const transaction = core_model_1.RejectVoteTransaction.fromObject({
            ...body,
...
RejectVoteTransactionFactory = __decorate([
    util_1.Injectable(),
...
exports.RejectVoteTransactionFactory = RejectVoteTransactionFactory;
