...
const { ConsensusException } = core_util_exception_1.CoreExceptionGenerator("VERIFIER", "AcceptVoteLogicVerifier");
let AcceptVoteLogicVerifier = class AcceptVoteLogicVerifier extends _txbaseLogicVerifier_1.TransactionLogicVerifier {
    constructor() {
        super();
    }
     ...
     * @param accountInfo
     */
    isAcceptVoteAlready(accountInfo) {
        if (accountInfo.isAcceptVote) {
            throw new ConsensusException(core_util_exception_1.DELEGATE_IS_ALREADY_ACCEPT_VOTE, {
                address: accountInfo.address,
...
AcceptVoteLogicVerifier = __decorate([
    util_1.Injectable(),
    __metadata("design:paramtypes", [])
], AcceptVoteLogicVerifier);
exports.AcceptVoteLogicVerifier = AcceptVoteLogicVerifier;
//# sourceMappingURL=acceptVoteLogicVerifier.js.map