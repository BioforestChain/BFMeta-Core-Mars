...
let BeExchangeAssetLogicVerifier = class BeExchangeAssetLogicVerifier extends _txbaseLogicVerifier_1.TransactionLogicVerifier {
    constructor() {
        super();
    }
     ...
     */
    isValidRecipientId(transaction, toExchangeAssetJson) {
     ...
     * @param toExchangeAssetJson
     */
    isDependentTransactionMatch(transaction, toExchangeAssetJson) {
        const Function_Exception_Detail = {
            function: "isDependentTransactionMatch",
        };
        const beExchangeAssetAsset = transaction.asset.beExchangeAsset;
        const { exchangeAsset, applyBlockHeight, numberOfEffectiveBlocks, transactionRangeType, transactionRange, } = beExchangeAssetAsset;
     ...
     */
    async isValidToUnfrozenAsset(transaction, toExchangeAssetJson, currentBlockHeight, accountGetterHelper = this.accountGetterHelper) {
        const Function_Exception_Detail = {
        ...
        // 校验是否还有剩余的可交换资产
        const frozenAsset = await accountGetterHelper.getFrozenAsset(toExchangeAssetJson.senderId, toExchangeAssetJson.signature);
        if (!frozenAsset) {
...
BeExchangeAssetLogicVerifier = __decorate([
    util_1.Injectable(),
    __metadata("design:paramtypes", [])
], BeExchangeAssetLogicVerifier);
exports.BeExchangeAssetLogicVerifier = BeExchangeAssetLogicVerifier;
//# sourceMappingURL=beExchangeAssetLogicVerifier.js.map