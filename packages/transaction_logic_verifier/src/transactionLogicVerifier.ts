...
export const TRANSACTION_LOGIC_VERIFIER_TYPES_MAP = (() => {
  ...
  (
    [
      ...
      [TRANSACTION_TYPES_BASE.INCREASE_ASSET, ATOM_TRSLGCVFR.IncreaseAssetLogicVerifier],
      [TRANSACTION_TYPES_BASE.DESTROY_ASSET, ATOM_TRSLGCVFR.DestroyAssetLogicVerifier],
      ...
      [TRANSACTION_TYPES_BASE.STAKE_ASSET, ATOM_TRSLGCVFR.StakeAssetLogicVerifier],
      [TRANSACTION_TYPES_BASE.UNSTAKE_ASSET, ATOM_TRSLGCVFR.UnstakeAssetLogicVerifier],
      ...
      [TRANSACTION_TYPES_BASE.DESTROY_ENTITY, ATOM_TRSLGCVFR.DestroyEntityLogicVerifier],
      [TRANSACTION_TYPES_BASE.ISSUE_ENTITY_MULTI, ATOM_TRSLGCVFR.IssueEntityMultiLogicVerifier],
      ...
      [TRANSACTION_TYPES_BASE.ISSUE_CERTIFICATE, ATOM_TRSLGCVFR.IssueCertificateLogicVerifier],
      [TRANSACTION_TYPES_BASE.DESTROY_CERTIFICATE, ATOM_TRSLGCVFR.DestroyCertificateLogicVerifier],
