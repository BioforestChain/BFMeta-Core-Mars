import { ChainChannel, ChainChannelGroup, CHAIN_CHANNEL_GROUP_ARGS } from "./channel/index";
import { CoreExceptionGenerator } from "../../helper/src/exception";
import { Injectable, ModuleStroge, Resolve } from "@bfchain/util";
import { CHANNEL_ARGS } from "../model/channel";
const {} = CoreExceptionGenerator("CONTROLLER", "ChannelCore");
