...
export class ToExchangeAssetModel extends Message<ToExchangeAssetModel>
...
export class ToExchangeAssetAssetModel extends Message<ToExchangeAssetAssetModel>
