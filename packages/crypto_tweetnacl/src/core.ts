...
export const _0 = new ByteArray(16);
export const _9 = new ByteArray(32);
_9[0] = 9;
...
export function addition(o: NumArray, a: NumArray, b: NumArray) {
  for (let i = 0; i < 16; i++) o[i] = a[i] + b[i];
}

export function subtraction(o: NumArray, a: NumArray, b: NumArray) {
  for (let i = 0; i < 16; i++) o[i] = a[i] - b[i];
}

export function multiplication(o: NumArray, a: NumArray, b: NumArray) {
  // prettier-ignore
  let v, c,
...
export function squaring(o: NumArray, a: NumArray) {
  multiplication(o, a, a);
}
