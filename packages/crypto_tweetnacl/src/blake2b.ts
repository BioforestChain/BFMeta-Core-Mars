...
export interface Blake2B {
  b: ByteArray;
  h: WordArray;
  /** input count*/ t: number;
  /** pointer within buffer*/ c: number;
  /** output length in bytes*/ outlen: number;
}
...
const BLAKE2B_IV32 = new WordArray([
  0xf3bcc908,
  0x6a09e667,
  0x84caa73b,
  0xbb67ae85,
...
const v = new WordArray(32);
const m = new WordArray(32);
...
function B2B_GET32(arr: ByteArray, i: number): number {
